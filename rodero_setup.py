...
electrode_data_filename = meta_data_dir + 'geometric_data/rodero_'+mesh_number+'_electrode_xyz.csv'
...
########################################################################################################################
# Step 6: Run Alya simulation and post-processing


########################################################################################################################
# Step 7: Read in post-processed Alya files
simulation_dir = simulation_dir + 'rodero_baseline_simulation_ep_rodero_'+mesh_number+'_fine/'
